"use client";
import { cn, stopClickEventBubling } from "@/app/utils/helper";
...
const Model = ({
  ...
  const handleSecondaryActionSubmit = useCallback(() => {
  ...
  return (
    <div
      onClick={handleClose}
      className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus-within:outline-none bg-neutral-800/70"
    >
      <div
